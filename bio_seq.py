...
class bio_seq:
    ...
    def __init__(self, seq="ATCG", seq_type="DNA", label="No Label"):
        ...
        assert (
            self.is_valid
        ), f"Provided data does not seem to be a correct {self.seq_type} sequence"
    ...
    def proteins_from_rf(self, aa_seq):
        """Compute all possible proteins in an aminoacid seq and return a list of possible proteins,预测一个基因组中可能编码蛋白质的区域"""
        current_prot = []
        proteins = []
        for aa in aa_seq:
            if aa == "_":
